...
class DataProcessing:
    ...
    def Process_data(self, batch_size):
        ...
        # print(self.train_data_list[0].edge_index)
...
def train(data, model):
    ...
    x_recon, edge_attr_recon = torch.split(x_attr, [data.x.size(-1), data.edge_attr.size(-1)], dim=-1)
    # follow direction dim=-1 and divide into 2 pieces，the size of each piece are dataset.num_features, 2, dataset.num_edge_features
...
if __name__ == "__main__":
    ...
    row_data = read_csv("/code/src/SFC/CODER/EDcode/Network_1/data_1.csv")
    ...
    # Save the model
    torch.save(model.state_dict(), "/code/src/SFC/CODER/EDcode/Network_1/model_1.pth")
